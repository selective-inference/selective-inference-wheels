...
be something like::
    ...
    wheel-uploader -u $CDN_URL -s -v -w ~/wheelhouse -t macosx selectinf $VERSION
    wheel-uploader -u $CDN_URL -s -v -w ~/wheelhouse -t manylinux1 selectinf $VERSION
    wheel-uploader -u $CDN_URL -s -v -w ~/wheelhouse -t win selectinf $VERSION
